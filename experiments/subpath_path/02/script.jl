...
for row_index in task_index:n_tasks:size(args_df, 1)
    ...
    records = [
        (
            ...
            lp_mean_subpath_ncust = get(r_LP_results, "mean_subpath_ncust", nothing),
            lp_weighted_mean_subpath_ncust = get(r_LP_results, "weighted_mean_subpath_ncust", nothing),
            ...
            lp_mean_path_ncust = get(r_LP_results, "mean_path_ncust", nothing),
            lp_weighted_mean_path_ncust = get(r_LP_results, "weighted_mean_path_ncust", nothing),
            ...
            lp_utilization = get(r_LP_results, "utilization", nothing),
            lp_driving_time_proportion = get(r_LP_results, "driving_time_proportion", nothing),
            lp_charging_time_proportion = get(r_LP_results, "charging_time_proportion", nothing),
            ...
            ip_mean_subpath_ncust = get(r_IP_results, "mean_subpath_ncust", nothing),
            ip_weighted_mean_subpath_ncust = get(r_IP_results, "weighted_mean_subpath_ncust", nothing),
            ...
            ip_mean_path_ncust = get(r_IP_results, "mean_path_ncust", nothing),
            ip_weighted_mean_path_ncust = get(r_IP_results, "weighted_mean_path_ncust", nothing),
            ...
            ip_utilization = get(r_IP_results, "utilization", nothing),
            ip_driving_time_proportion = get(r_IP_results, "driving_time_proportion", nothing),
            ip_charging_time_proportion = get(r_IP_results, "charging_time_proportion", nothing),
        )
    ]
