...
function run_instance(
    ...
    records = [
        (
            ...
            use_lmSR3_cuts = false,
            # Time taken
            time_taken = CG_all_params[1]["time_taken"],
            sp_base_time_taken_total = CG_all_params[1]["sp_base_time_taken_total"],
            sp_full_time_taken_total = CG_all_params[1]["sp_full_time_taken_total"],
            sp_time_taken_total = CG_all_params[1]["sp_time_taken_total"],
            lp_relaxation_time_taken_total = CG_all_params[1]["lp_relaxation_time_taken_total"],
            sp_base_time_taken_mean = CG_all_params[1]["sp_base_time_taken_mean"],
            sp_full_time_taken_mean = CG_all_params[1]["sp_full_time_taken_mean"],
            sp_time_taken_mean = CG_all_params[1]["sp_time_taken_mean"],
            lp_relaxation_time_taken_mean = CG_all_params[1]["lp_relaxation_time_taken_mean"],
            # n_iterations
            counter = CG_all_params[1]["counter"],
