...
method_params = [
    ...
    ("ours", false,  true,  true,  "small",  true),
    ("ours", false,  true,  true, "medium",  true),
    ("ours", false,  true,  true,  "large",  true),
    ("ours",  true, false, false,  "small", false),
    ("benchmark", false,  true,  true,  "small",  true),
    ("benchmark", false,  true,  true, "medium",  true),
    ("benchmark", false,  true,  true,  "large",  true),
    ("benchmark",  true, false, false,  "small", false),
]
